...
public class ScreeningResource {
	...
	@GetMapping("/specific")
	public ResponseEntity<List<Screening>> getParticularScreening(@RequestParam String state, @RequestParam String city, @RequestParam String street,
			@RequestParam String theatreName, @RequestParam String auditoriumName,
